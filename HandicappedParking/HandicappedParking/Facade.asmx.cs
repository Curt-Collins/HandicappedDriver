...
using HandicappedParking.CoreSystem;
// new code ends - Richu

// Commenting all function body to check weather the GUI is calling the methods
...
namespace HandicappedParking
{
    ...
    public class Facade : System.Web.Services.WebService
    {
        ...
        //s = jSON.Serialize<ParkingSpaceData>(p.NavString); this goes in the function above just before return statement
        ...
        public static string ShowExistingReservation(string username)
        {
            ...
            // the code below was already commented out before I commented
